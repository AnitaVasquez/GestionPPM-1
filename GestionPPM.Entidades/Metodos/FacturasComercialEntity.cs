...
namespace GestionPPM.Entidades.Metodos
{
    public static class FacturasComercialEntity
    {
        ...
        public static RespuestaTransaccion FacturarSAFI(int id_prefactura_id)
        {
            using (var transaction = db.Database.BeginTransaction())
            {
                ...
                { 
                    ...
                    //Generar Prefactura
                    var data = ProcesaFacturaSAFI(ListadoFacturarSAFI, secuencial.ToString());
        ...
        public static List<Wrapper> ProcesaFacturaSAFI(List<ListadoFacturarSAFI> ListadoFactura, string secuencial)
        {
                ...
                if (ListadoFactura.Any())
                {
                    foreach (var ele in ListadoFactura)
                    {
                        ...
                        var detItem = new DetalleFactura
                        {
                            ...
                            CodigoProducto = ele.CodigoProducto,
                            NombreProducto = ele.NombreProdcuto,
                            RUCProveedor = "",
                            Proveedor = "",
