    ...
    public class FacturasPresupuestosController : Controller
    {
        ...
        public ActionResult ReporteMatriz(int id, string tituloReporte, string ejecutivo, DateTime fechaInicio, DateTime fechaFin)
        {
            ...
            { 
                ...
                int columnaFinalDocumentoExcel = 8;
                ...
                // TITULO REPORTE
                using (var range = ws.Cells[1, 5, 2, 7])
                {
                ...
                //FECHA
                using (var range = ws.Cells[1, 8, 2, 8])
                {
                ...
                var columnas = new List<string> { "N°", "N. PRESUPUESTO", "N. FACTURA","FECHA FACTURA", "DETALLE", "VALOR", "IVA", "TOTAL" };
