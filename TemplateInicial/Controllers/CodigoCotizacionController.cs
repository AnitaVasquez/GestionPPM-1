...
{
    [Autenticado]
    public class CodigoCotizacionController : BaseAppController
    {
        ...
        //// Vista Detallada
        //[HttpGet]
        //public async Task<PartialViewResult> IndexGrid2(String search)
        //{
        //    ViewBag.NombreListado = Etiquetas.TituloGridCodigoCotizacion;
        //    //Controlar permisos
        //    var user = ViewData["usuario"] = System.Web.HttpContext.Current.Session["usuario"];
        ...
        //    // Only grid query values will be available here.
        //    return PartialView("_IndexGrid2", await Task.Run(() => listado));
        //}

        //[HttpGet]
        //public async Task<PartialViewResult> IndexGrid3(String search)
        //{
        //    ViewBag.NombreListado = Etiquetas.TituloGridCodigoCotizacion;
        //    //Controlar permisos
        //    var user = ViewData["usuario"] = System.Web.HttpContext.Current.Session["usuario"];
        ...
        //    // Only grid query values will be available here.
        //    return PartialView("_IndexGrid3", await Task.Run(() => listado));
        //}
