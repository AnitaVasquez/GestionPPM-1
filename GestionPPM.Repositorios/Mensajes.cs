...
namespace GestionPPM.Repositorios
{
    public static class Mensajes
    {
        ...
        public static string MensajeValidacionDetallesMIDS = "El comercio requiere que se agregue al menos 1 MID.";

        public static string MensajeValidacionComercioRepetido= "El comercio asociado al RUC {0} ya fue registrado previamente.";
    }
}